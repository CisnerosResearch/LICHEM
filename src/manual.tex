...
% Formatting code (with included listings)
...
% For smaller c++ code
\lstnewenvironment{lwcppcode}
  {\lstset{language=C++, keywordstyle=\color{blue},
           stringstyle=\color{seagreen},
           commentstyle=\color{violet},
           basicstyle=\ttfamily\scriptsize, showstringspaces=false}
  }
  {}
...
% Disallow word hyphenation
\tolerance=1
\emergencystretch=\maxdimen
\hyphenpenalty=10000
\hbadness=10000

% Number subsections and include in table of contents
...
\item All in-line comments need at least 2 spaces of separation from the line. \\
      Example:
	  \begin{pycode}
...
\begin{table}[hbt]
 ...
 \hline
% Use -{}- because -- gets converted to an en-dash
...
the initial structure given with the \texttt{-x} flag, multi-replica 
simulations require structural information for each replica.
