...
class QMMMSettings
{
  ...
  public:
    ...
    // START: Hatice GOKCAN
    // Start: Aug 28 2018
    double EComplforw; // Energy of forward complex
    double EComplback; // Energy of reverse complex
    // End: Aug 28 2018
    int Nqsm; // The number of beads in starting xyz in QSM
    bool restrMM; // If MM positions will be restrained
    double restrConst; // force constant for restrains
    double QMRMSForceTol;
    double QMMaxForceTol;
    double MaxQMSteps;
    bool KeepFiles;
    bool debug;
