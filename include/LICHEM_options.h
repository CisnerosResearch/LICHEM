...
namespace LICHEMOpts
{
  ...
  // If (BeadProb+CentProb) > 1) then there is a chance that multiple
  //  particles move during a step.

  // If (BeadProb+CentProb) < 1) then there is a chance that no prarticles
  //  move during a step.
